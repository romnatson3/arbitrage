...
class Position(BaseModel):
    ...
    def get_ask_bid_empty_data() -> dict:
        data = {
            ...
            'spread_points': None,
            'spread_percent': None,
            'first_exchange_previous_ask_entry': None,
            'first_exchange_last_ask_entry': None,
            'first_exchange_previous_bid_entry': None,
            'first_exchange_last_bid_entry': None,
            'second_exchange_previous_ask_entry': None,
            'second_exchange_last_ask_entry': None,
            'second_exchange_previous_bid_entry': None,
