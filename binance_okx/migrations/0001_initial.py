    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_part_size', models.FloatField(default=0.0, help_text='First part size, %', verbose_name='First part size')),
                ('second_part_size', models.FloatField(default=0.0, help_text='Second part size, %', verbose_name='Second part size')),
                ...
                ('first_account', models.ForeignKey(help_text='First Account', on_delete=django.db.models.deletion.CASCADE, related_name='strategies_set', to='binance_okx.account')),
                ('second_account', models.ForeignKey(help_text='Second Account', on_delete=django.db.models.deletion.CASCADE, related_name='strategies', to='binance_okx.account')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='updated_at')),
                ('symbol', models.CharField(max_length=20, primary_key=True, serialize=False, unique=True)),
                ('binance', models.ForeignKey(help_text='Binance Symbol', on_delete=django.db.models.deletion.CASCADE, related_name='binance', to='binance_okx.okxsymbol')),
                ('okx', models.ForeignKey(help_text='OKX Symbol', on_delete=django.db.models.deletion.CASCADE, related_name='okx', to='binance_okx.binancesymbol')),
            ],
            options={
                'verbose_name': 'Symbol',
